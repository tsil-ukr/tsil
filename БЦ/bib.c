...
typedef struct Виділяч {
  ...
  п8* (*виділити_сиру_памʼять)(Виділяч* виділяч, природне розмір);

  п8* (*перевиділити_сиру_памʼять)(Виділяч* виділяч,
                                   п8* значення,
                                   природне новий_розмір);

  void (*звільнити_сиру_памʼять)(Виділяч* виділяч, п8* значення);
} Виділяч;
...
extern п8* системний_виділяч_виділити_сиру_памʼять(Виділяч* виділяч,
                                                   природне розмір) {
  return malloc(розмір);
}

extern п8* системний_виділяч_перевиділити_сиру_памʼять(Виділяч* виділяч,
                                                       п8* значення,
                                                       природне новий_розмір) {
  return realloc(значення, новий_розмір);
}

extern void системний_виділяч_звільнити_сиру_памʼять(Виділяч* виділяч,
                                                     п8* значення) {
  free(значення);
}
