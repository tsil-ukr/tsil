...
void tsilparserParserInitialize() {
  ...
  auto staticData = std::make_unique<TsilParserStaticData>(
    std::vector<std::string>{
      "file", "program", "program_element", "include", "structure", "structure_generics", 
    ...
    std::vector<std::string>{
      ...
      "KW_WHILE", "KW_RETURN", "KW_STRUCT", "KW_AS", "KW_SIZEOF", "KW_SECTION", 
      "KW_IMPORT", "KW_EXPORT", "KW_COMPOSITION", "KW_PROPERTY", "KW_PUBLIC", 
      "KW_PRIVATE", "KW_LOCAL", "KW_NOT", "KW_OR", "KW_AND", "KW_INCLUDE", 
      ...
      "QUOTE_CLOSE", "INTEGER", "FLOAT", "HEX", "BIN", "ID", "STRING", "COMMENT", 
      "LINE_COMMENT", "NL", "WS"
    }
  );
  static const int32_t serializedATNSegment[] = {
  	4,1,59,551,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
  	...
  	1,2,1,2,1,2,3,2,104,8,2,1,3,1,3,1,3,1,3,1,4,1,4,1,4,1,4,1,4,1,4,3,4,116,
  	8,4,1,4,1,4,3,4,120,8,4,1,4,1,4,1,5,1,5,1,5,5,5,127,8,5,10,5,12,5,130,
  	9,5,1,6,1,6,1,7,1,7,1,7,5,7,137,8,7,10,7,12,7,140,9,7,1,7,3,7,143,8,7,
  	1,8,1,8,1,8,1,8,1,9,3,9,150,8,9,1,9,1,9,1,9,3,9,155,8,9,1,9,1,9,1,10,
  	1,10,1,10,5,10,162,8,10,10,10,12,10,165,9,10,1,10,3,10,168,8,10,1,11,
  	1,11,1,11,1,11,1,12,1,12,1,12,1,12,1,12,1,12,3,12,180,8,12,1,12,1,12,
  	3,12,184,8,12,1,12,1,12,1,12,1,12,3,12,190,8,12,1,12,1,12,1,12,1,12,3,
  	12,196,8,12,1,13,1,13,1,13,3,13,201,8,13,1,13,1,13,1,13,3,13,206,8,13,
  	1,13,1,13,1,14,1,14,1,14,3,14,213,8,14,1,14,1,14,1,14,3,14,218,8,14,1,
  	14,1,14,1,15,1,15,1,15,5,15,225,8,15,10,15,12,15,228,9,15,1,16,1,16,1,
  	17,1,17,1,17,1,17,5,17,236,8,17,10,17,12,17,239,9,17,1,17,1,17,1,18,1,
  	18,1,18,1,18,1,18,3,18,248,8,18,1,19,1,19,1,19,1,19,3,19,254,8,19,1,19,
  	1,19,1,19,1,19,3,19,260,8,19,1,19,3,19,263,8,19,1,20,1,20,1,20,1,20,3,
  	20,269,8,20,1,20,1,20,1,21,1,21,1,21,1,21,3,21,277,8,21,1,21,1,21,1,21,
  	1,21,1,21,1,21,1,21,1,21,3,21,287,8,21,1,22,1,22,1,22,1,22,1,23,1,23,
  	1,23,1,23,1,23,1,23,1,24,1,24,1,24,1,24,3,24,303,8,24,1,24,1,24,1,25,
  	1,25,1,25,1,25,1,25,1,25,1,25,1,25,1,25,1,25,1,25,1,25,1,25,1,25,3,25,
  	321,8,25,1,25,1,25,1,25,1,25,1,25,1,25,1,25,1,25,5,25,331,8,25,10,25,
  	12,25,334,9,25,1,25,1,25,3,25,338,8,25,1,25,1,25,3,25,342,8,25,1,25,1,
  	25,1,25,1,25,3,25,348,8,25,1,25,5,25,351,8,25,10,25,12,25,354,9,25,1,
  	26,1,26,1,26,3,26,359,8,26,1,27,1,27,1,27,1,27,1,27,1,27,1,27,1,27,1,
  	27,1,27,3,27,371,8,27,1,27,1,27,1,27,1,27,1,27,1,27,1,27,1,27,1,27,1,
  	27,1,27,1,27,1,27,1,27,1,27,1,27,1,27,1,27
  	495,5,47,0,0,495,507,1,0,0,0,496,497,3,44,22,0,497,498,5,47,0,0,498,507,
  	1,0,0,0,499,500,3,46,23,0,500,501,5,47,0,0,501,507,1,0,0,0,502,503,3,
  	54,27,0,503,504,5,47,0,0,504,507,1,0,0,0,505,507,5,47,0,0,506,491,1,0,
  	0,0,506,492,1,0,0,0,506,493,1,0,0,0,506,496,1,0,0,0,506,499,1,0,0,0,506,
  	502,1,0,0,0,506,505,1,0,0,0,507,73,1,0,0,0,508,510,5,8,0,0,509,511,3,
  	54,27,0,510,509,1,0,0,0,510,511,1,0,0,0,511,75,1,0,0,0,512,520,5,33,0,
  	0,513,520,5,35,0,0,514,520,5,34,0,0,515,516,5,26,0,0,516,520,5,26,0,0,
  	517,518,5,25,0,0,518,520,5,25,0,0,519,512,1,0,0,0,519,513,1,0,0,0,519,
  	514,1,0,0,0,519,515,1,0,0,0,519,517,1,0,0,0,520,77,1,0,0,0,521,522,5,
  	24,0,0,522,532,5,24,0,0,523,524,5,45,0,0,524,532,5,24,0,0,525,532,5,25,
  	0,0,526,532,5,26,0,0,527,528,5,25,0,0,528,532,5,24,0,0,529,530,5,26,0,
  	0,530,532,5,24,0,0,531,521,1,0,0,0,531,523,1,0,0,0,531,525,1,0,0,0,531,
  	526,1,0,0,0,531,527,1,0,0,0,531,529,1,0,0,0,532,79,1,0,0,0,533,534,5,
  	35,0,0,534,540,5,35,0,0,535,536,5,34,0,0,536,540,5,34,0,0,537,540,5,21,
  	0,0,538,540,5,22,0,0,539,533,1,0,0,0,539,535,1,0,0,0,539,537,1,0,0,0,
  	539,538,1,0,0,0,540,81,1,0,0,0,541,542,7,2,0,0,542,83,1,0,0,0,543,545,
  	5,54,0,0,544,543,1,0,0,0,544,545,1,0,0,0,545,546,1,0,0,0,546,547,5,55,
  	0,0,547,85,1,0,0,0,548,549,5,54,0,0,549,87,1,0,0,0,60,94,103,115,119,
  	128,138,142,149,154,163,167,179,183,189,195,200,205,212,217,226,237,247,
  	253,259,262,268,276,286,302,320,332,337,341,347,350,352,358,370,390,392,
  	403,414,419,425,429,435,443,451,459,463,470,474,483,489,506,510,519,531,
  	539,544
  };
...
TsilParser::IncludeContext* TsilParser::Program_elementContext::include() {
  return getRuleContext<TsilParser::IncludeContext>(0);
}
...
TsilParser::IncludeContext::IncludeContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}

tree::TerminalNode* TsilParser::IncludeContext::KW_INCLUDE() {
  return getToken(TsilParser::KW_INCLUDE, 0);
}

tree::TerminalNode* TsilParser::IncludeContext::SEMICOLON() {
  return getToken(TsilParser::SEMICOLON, 0);
}

TsilParser::StringContext* TsilParser::IncludeContext::string() {
  return getRuleContext<TsilParser::StringContext>(0);
}


size_t TsilParser::IncludeContext::getRuleIndex() const {
  return TsilParser::RuleInclude;
}

void TsilParser::IncludeContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TsilParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterInclude(this);
}

void TsilParser::IncludeContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TsilParserListener *>(listener);
  if (parserListener != nullptr)
...
std::any TsilParser::IncludeContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<TsilParserVisitor*>(visitor))
...
TsilParser::IncludeContext* TsilParser::include() {
  IncludeContext *_localctx = _tracker.createInstance<IncludeContext>(_ctx, getState());
  enterRule(_localctx, 6, TsilParser::RuleInclude);
  ...
  try {
    enterOuterAlt(_localctx, 1);
    setState(105);
    match(TsilParser::KW_INCLUDE);
    setState(106);
    antlrcpp::downCast<IncludeContext *>(_localctx)->i_path = string();
    setState(107);
    match(TsilParser::SEMICOLON);
...
TsilParser::StructureContext* TsilParser::structure() {
  ...
  enterRule(_localctx, 8, TsilParser::RuleStructure);
  size_t _la = 0;
...
TsilParser::Structure_genericsContext* TsilParser::structure_generics() {
  ...
  enterRule(_localctx, 10, TsilParser::RuleStructure_generics);
  size_t _la = 0;
...
TsilParser::Structure_genericContext* TsilParser::structure_generic() {
  ...
  enterRule(_localctx, 12, TsilParser::RuleStructure_generic);
...
TsilParser::Structure_paramsContext* TsilParser::structure_params() {
  ...
  enterRule(_localctx, 14, TsilParser::RuleStructure_params);
  size_t _la = 0;
...
TsilParser::Structure_paramContext* TsilParser::structure_param() {
  ...
  enterRule(_localctx, 16, TsilParser::RuleStructure_param);
...
TsilParser::ConstructorContext* TsilParser::constructor() {
  ...
  enterRule(_localctx, 18, TsilParser::RuleConstructor);
  size_t _la = 0;
...
TsilParser::Constructor_argsContext* TsilParser::constructor_args() {
  ...
  enterRule(_localctx, 20, TsilParser::RuleConstructor_args);
  size_t _la = 0;
...
TsilParser::Constructor_argContext* TsilParser::constructor_arg() {
  ...
  enterRule(_localctx, 22, TsilParser::RuleConstructor_arg);
...
TsilParser::Diia_headContext* TsilParser::diia_head() {
  ...
  enterRule(_localctx, 24, TsilParser::RuleDiia_head);
  size_t _la = 0;
...
TsilParser::DiiaContext* TsilParser::diia() {
  ...
  enterRule(_localctx, 26, TsilParser::RuleDiia);
  size_t _la = 0;
...
TsilParser::Diia_declarationContext* TsilParser::diia_declaration() {
  ...
  enterRule(_localctx, 28, TsilParser::RuleDiia_declaration);
  size_t _la = 0;
...
TsilParser::SectionContext* TsilParser::section() {
  ...
  enterRule(_localctx, 34, TsilParser::RuleSection);
  size_t _la = 0;
...
TsilParser::Section_elementContext* TsilParser::section_element() {
  ...
  enterRule(_localctx, 36, TsilParser::RuleSection_element);
...
TsilParser::IfContext* TsilParser::if_() {
  ...
  enterRule(_localctx, 38, TsilParser::RuleIf);
  size_t _la = 0;
...
TsilParser::WhileContext* TsilParser::while_() {
  ...
  enterRule(_localctx, 40, TsilParser::RuleWhile);
  size_t _la = 0;
...
TsilParser::DefineContext* TsilParser::define() {
  ...
  enterRule(_localctx, 42, TsilParser::RuleDefine);
  size_t _la = 0;
...
TsilParser::SetContext* TsilParser::set() {
  ...
  enterRule(_localctx, 46, TsilParser::RuleSet);
...
TsilParser::SizeofContext* TsilParser::sizeof_() {
  ...
  enterRule(_localctx, 48, TsilParser::RuleSizeof);
...
TsilParser::AtomContext* TsilParser::atom(int precedence) {
  ...
  enterRecursionRule(_localctx, 50, TsilParser::RuleAtom, precedence);
...
TsilParser::MoleculeContext* TsilParser::molecule() {
  ...
  enterRule(_localctx, 52, TsilParser::RuleMolecule);
...
TsilParser::ExprContext* TsilParser::expr(int precedence) {
  ...
  enterRecursionRule(_localctx, 54, TsilParser::RuleExpr, precedence);
...
TsilParser::Identifiers_chainContext* TsilParser::identifiers_chain(int precedence) {
  ...
  enterRecursionRule(_localctx, 56, TsilParser::RuleIdentifiers_chain, precedence);
...
tree::TerminalNode* TsilParser::TypeContext::BRACKET_OPEN() {
  return getToken(TsilParser::BRACKET_OPEN, 0);
}

tree::TerminalNode* TsilParser::TypeContext::BRACKET_CLOSE() {
  return getToken(TsilParser::BRACKET_CLOSE, 0);
}
...
TsilParser::ExprContext* TsilParser::TypeContext::expr() {
  return getRuleContext<TsilParser::ExprContext>(0);
}
...
TsilParser::Full_typeContext* TsilParser::full_type(int precedence) {
  ...
  enterRecursionRule(_localctx, 58, TsilParser::RuleFull_type, precedence);
    ...
    switch (_input->LA(1)) {
      case TsilParser::ID: {
        ...
        case 1: {
          ...
          match(TsilParser::BRACKET_OPEN);
          setState(422);
          antlrcpp::downCast<TypeContext *>(_localctx)->ft_arr_size = expr(0);
          setState(423);
          match(TsilParser::BRACKET_CLOSE);
          break;
        }
...
TsilParser::Simple_function_type_argsContext* TsilParser::simple_function_type_args() {
  ...
  enterRule(_localctx, 60, TsilParser::RuleSimple_function_type_args);
  size_t _la = 0;
...
TsilParser::ParamsContext* TsilParser::params() {
  ...
  enterRule(_localctx, 64, TsilParser::RuleParams);
...
TsilParser::ParamContext* TsilParser::param() {
  ...
  enterRule(_localctx, 66, TsilParser::RuleParam);
...
TsilParser::BodyContext* TsilParser::body() {
  ...
  enterRule(_localctx, 68, TsilParser::RuleBody);
  size_t _la = 0;
...
TsilParser::Body_element_or_returnContext* TsilParser::body_element_or_return() {
  ...
  enterRule(_localctx, 70, TsilParser::RuleBody_element_or_return);
...
TsilParser::Return_body_elementContext* TsilParser::return_body_element() {
  ...
  enterRule(_localctx, 74, TsilParser::RuleReturn_body_element);
  size_t _la = 0;
...
TsilParser::NumberContext* TsilParser::number() {
  ...
  enterRule(_localctx, 82, TsilParser::RuleNumber);
  size_t _la = 0;
...
TsilParser::StringContext* TsilParser::string() {
  ...
  enterRule(_localctx, 84, TsilParser::RuleString);
  size_t _la = 0;
...
TsilParser::IdentifierContext* TsilParser::identifier() {
  ...
  enterRule(_localctx, 86, TsilParser::RuleIdentifier);
...
bool TsilParser::sempred(RuleContext *context, size_t ruleIndex, size_t predicateIndex) {
  switch (ruleIndex) {
    case 25: return atomSempred(antlrcpp::downCast<AtomContext *>(context), predicateIndex);
    case 27: return exprSempred(antlrcpp::downCast<ExprContext *>(context), predicateIndex);
    case 28: return identifiers_chainSempred(antlrcpp::downCast<Identifiers_chainContext *>(context), predicateIndex);
    case 29: return full_typeSempred(antlrcpp::downCast<Full_typeContext *>(context), predicateIndex);
