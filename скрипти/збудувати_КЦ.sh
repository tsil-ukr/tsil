...
KTS_FILES=("Ц.ц" "К/К.ц" "К/КЗвернутись.ц" "К/КВиконати.ц" "К/КВиконатиШаблон.ц" "К/КПеревизначити.ц" "К/КЗмінити.ц" "К/КОперація.ц" "К/КЗмінити.ц" "К/КОтримати.ц" "К/КСтворитиЦіль.ц")
