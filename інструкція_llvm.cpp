...
Значення* __ПМЛЛВМ__вказівка_остача_логічне(Крок* крок,
                                            ...
                                            Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateURem(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_остача_ц8(Крок* крок,
                                       ...
                                       Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateSRem(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_остача_д32(Крок* крок,
                                        ...
                                        Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateFRem(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_рівно_логічне(Крок* крок,
                                           ...
                                           Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateICmpEQ(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_рівно_д32(Крок* крок,
                                       ...
                                       Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateFCmpUEQ(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_не_рівно_логічне(Крок* крок,
                                              ...
                                              Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateICmpNE(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_не_рівно_д32(Крок* крок,
                                          ...
                                          Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateFCmpUNE(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_більше_логічне(Крок* крок,
                                            ...
                                            Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateICmpUGT(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_більше_ц8(Крок* крок,
                                       ...
                                       Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateICmpSGT(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_більше_д32(Крок* крок,
                                        ...
                                        Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateFCmpUGT(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_менше_логічне(Крок* крок,
                                           ...
                                           Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateICmpULT(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_менше_ц8(Крок* крок,
                                      ...
                                      Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateICmpSLT(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_менше_д32(Крок* крок,
                                       ...
                                       Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateFCmpULT(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_більше_рівно_логічне(Крок* крок,
                                                  ...
                                                  Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateICmpUGE(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_більше_рівно_ц8(Крок* крок,
                                             ...
                                             Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateICmpSGE(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_більше_рівно_д32(Крок* крок,
                                              ...
                                              Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateFCmpUGE(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_менше_рівно_логічне(Крок* крок,
                                                 ...
                                                 Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateICmpULE(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_менше_рівно_ц8(Крок* крок,
                                            ...
                                            Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateICmpSLE(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_менше_рівно_д32(Крок* крок,
                                             ...
                                             Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateFCmpULE(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_зсунути_вліво_логічне(Крок* крок,
                                                   ...
                                                   Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateShl(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_зсунути_вправо_логічне(Крок* крок,
                                                    ...
                                                    Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateAShr(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_зсунути_вправо_п8(Крок* крок,
                                               ...
                                               Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateLShr(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_двійкове_і_логічне(Крок* крок,
                                                ...
                                                Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateAnd(ліво, право);
}
...
Значення* __ПМЛЛВМ__вказівка_двійкове_або_логічне(Крок* крок,
                                                  ...
                                                  Значення* право) {
  llvm::IRBuilder<> builder(крок);
  return builder.CreateOr(ліво, право);
}
...
void __ПМЛЛВМ__вказівка_змінити_крок_стрибка(Стрибок* стрибок, Крок* куди) {
