...
Модуль* __ПМЛЛВМ__створити_модуль(ю8* назва,
                                  позитивне архітектура,
                                  позитивне постачальник,
                                  позитивне система) {
  ...
  if (архітектура) {
    ...
    if (постачальник == ПОСТАЧАЛЬНИК_ЗАГАЛЬНИЙ) {
      targetTriple += "-pc";
    } else {
      return nullptr;
    }
...
Значення* __ПМЛЛВМ__створити_константу_даних(Модуль* модуль,
                                             позитивне розмір,
                                             памʼять_п8 дані) {
...
Значення* __ПМЛЛВМ__створити_пусте_значення(Модуль* модуль, Тип* тип) {
...
Значення* __ПМЛЛВМ__вказівка_отримати_значення(Крок* крок,
                                               Значення* значення,
                                               позитивне позиція) {
  llvm::IRBuilder<> builder(крок);

  return builder.CreateExtractValue(значення,
                                    {static_cast<unsigned int>(позиція)}, "v");
}
