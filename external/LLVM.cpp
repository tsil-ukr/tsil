...
#define ПЛАТФОРМА_ІКС86_64_ПК_ЛІНУКС_ГНУ 10
#define ПЛАТФОРМА_ААРЧ64_ПК_ЛІНУКС_ГНУ 11
#define ПЛАТФОРМА_ІКС86_64_ЕПЛ_ДАРВІН 20
#define ПЛАТФОРМА_ААРЧ64_ЕПЛ_ДАРВІН 21
#define ПЛАТФОРМА_ІКС86_64_ПК_ВІНДОВС_ГНУ 30
#define ПЛАТФОРМА_ААРЧ64_64_ПК_ВІНДОВС_ГНУ 31
#define ПЛАТФОРМА_ІКС86_64_ПК_ВІНДОВС_МСВС 32
#define ПЛАТФОРМА_ААРЧ64_64_ПК_ВІНДОВС_МСВС 33
...
Модуль* __ЛЛВМ__створити_модуль(ю8* назва, природне платформа) {
  ...
  if (платформа) {
    if (платформа == ПЛАТФОРМА_ІКС86_64_ПК_ЛІНУКС_ГНУ) {
      targetTriple = llvm::Triple("x86_64-pc-linux-gnu");
    } else if (платформа == ПЛАТФОРМА_ААРЧ64_ПК_ЛІНУКС_ГНУ) {
      targetTriple = llvm::Triple("aarch64-pc-linux-gnu");
    } else if (платформа == ПЛАТФОРМА_ІКС86_64_ЕПЛ_ДАРВІН) {
      targetTriple = llvm::Triple("x86_64-apple-darwin");
    } else if (платформа == ПЛАТФОРМА_ААРЧ64_ЕПЛ_ДАРВІН) {
      targetTriple = llvm::Triple("aarch64-apple-darwin");
    } else if (платформа == ПЛАТФОРМА_ІКС86_64_ПК_ВІНДОВС_ГНУ) {
      targetTriple = llvm::Triple("x86_64-pc-windows-gnu");
    } else if (платформа == ПЛАТФОРМА_ІКС86_64_ПК_ВІНДОВС_МСВС) {
      targetTriple = llvm::Triple("x86_64-pc-windows-msvc");
    } else if (платформа == ПЛАТФОРМА_ААРЧ64_64_ПК_ВІНДОВС_ГНУ) {
      targetTriple = llvm::Triple("aarch64-pc-windows-gnu");
    } else if (платформа == ПЛАТФОРМА_ААРЧ64_64_ПК_ВІНДОВС_МСВС) {
      targetTriple = llvm::Triple("aarch64-pc-windows-msvc");
